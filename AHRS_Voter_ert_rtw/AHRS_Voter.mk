...
## Generated on : Tue Sep 02 20:02:48 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\AHRS_Voter.exe
...
START_DIR                 = C:\Users\rarora\ONEDRI~1\Projects\CICDDE~1\SIMPLE~1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\AHRS_Voter.exe
...
SRCS = $(START_DIR)\AHRS_Voter_ert_rtw\AHRS_Voter.c

MAIN_SRC = $(START_DIR)\AHRS_Voter_ert_rtw\ert_main.c
...
{$(START_DIR)\AHRS_Voter_ert_rtw}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\AHRS_Voter_ert_rtw}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\AHRS_Voter_ert_rtw}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\AHRS_Voter_ert_rtw}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
AHRS_Voter.obj : "$(START_DIR)\AHRS_Voter_ert_rtw\AHRS_Voter.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\AHRS_Voter_ert_rtw\AHRS_Voter.c"


ert_main.obj : "$(START_DIR)\AHRS_Voter_ert_rtw\ert_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\AHRS_Voter_ert_rtw\ert_main.c"
